...
new class extends Component {
    ...
    private function loadSetupData(): void
    {
        ...
        try {
            if (!$user || !$user->two_factor_secret) {
                throw new Exception('Secret pengaturan autentikasi dua faktor tidak tersedia.');
            }
    ...
    public function getModalConfigProperty(): array
    {
        if ($this->setupComplete) {
            return [
                'title' => __('Autentikasi Dua Faktor Diaktifkan'),
                'description' => __('Autentikasi dua faktor sekarang diaktifkan. Pindai kode QR atau masukkan key setup di aplikasi autentikator Anda.'),
                'buttonText' => __('Tutup'),
            ];
        }
        ...
        if ($this->showVerificationStep) {
            return [
                'title' => __('Aktifkan Autentikasi Dua Faktor'),
                'description' => __('Untuk menyelesaikan pengaktifan autentikasi dua faktor, pindai kode QR atau masukkan key setup di aplikasi autentikator Anda.'),
                'buttonText' => __('Konfirmasi'),
            ];
        }
